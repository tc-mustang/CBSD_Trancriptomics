...
Using the reference chromosome 4 and chromosome 11 from kayondo et al. for foliar symptoms
...
load(file = "/home/DB2/Imputation/IMPUTE2/PROCCESING/FILTERS/Foliar_QTLS/kernelx2")
load(file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Accounting_for_QTL/CBSD3_random.Rdata")
load(file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Accounting_for_QTL/CBSD6_random.Rdata")
load(file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Accounting_for_QTL/CBSDR_random.Rdata")
...
Accountinga <- filter(Accounting, TRAIT != "CBSD3")

setwd("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Accounting_for_QTL/" )
tiff("Figure4", width = 6, height = 4, units = 'in', res = 350)

p <- ggplot(Accountinga, aes(factor(K), ACCURACIES))
p + geom_boxplot(aes(fill = SET)) + labs(x="") +  theme_bw() +
  facet_grid(. ~ TRAIT) +
  scale_fill_manual(values = c(kolor[1], "white", kolor[4])) +
  theme(plot.title=element_text(colour = "navyblue",face ="bold", size= 18, margin = margin(t=20, b=20)),
        ## Boxes from the grid
