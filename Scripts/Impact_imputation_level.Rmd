...
load("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/GB_GBS.RData")
load("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/BEAGLEI.RData")
load("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/BEAGLEII.RData")
...
p + geom_boxplot(aes(fill = Set)) + labs(title="Impact of Imputation Level on Accuracy", x="Imputation level") +  theme_bw() +
  ...
  theme(plot.title=element_text(colour = "navyblue",face ="bold", size= 15, margin = margin(t=20, b=20)),
...
load("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/IMPUTE290.RData")
load("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/IMPUTE2GBS.RData")
...
kolores <- wes_palette(name = "Royal1")



p <- ggplot(graph2, aes(factor(Trait), Accuracy))
p + geom_boxplot(aes(fill = Set)) + labs(title="Impact of Imputation Level on Accuracy", x="Imputation level") +  theme_bw() +
  scale_fill_manual(values = c(kolor[1],kolor[4],kolor[5],kolores[2])) +
...
Saving all the GS objects:

```{r}

save(GB_GBS, file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/GB_GBS.RData")
save(BEAGLEI, file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/BEAGLEI.RData")
save(BEAGLEII, file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/BEAGLEII.RData")
save(IMPUTE2, file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/IMPUTE2.RData")
save(IMPUTE290, file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/IMPUTE290.RData")
save(IMPUTE2GBS, file = "/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level/IMPUTE2GBS.RData")
...
setwd("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level" )
tiff("Part1", width = 5, height = 3, units = 'in', res = 350)


p <- ggplot(graph, aes(factor(Trait), Accuracy))
p + geom_boxplot(aes(fill = Set))  +  theme_bw() +
  scale_fill_manual(values = wes_palette("Zissou")) +
  theme(plot.title=element_text(colour = "navyblue",face ="bold", size= 15, margin = margin(t=20, b=20)),
        axis.title.y=element_text(margin=margin(0,20,0,0)),
        axis.text=element_text(size=9), 
        axis.title=element_text(size=12,face="bold"),
        axis.title.x=element_text(margin=margin(20,0,0,0)))  + ylim(0.28, 0.46)
...
setwd("/home/roberto/Desktop/JL-Presentation/PAG_2017/Results/Impact_Imputation_level" )
tiff("Part2", width = 5, height = 3, units = 'in', res = 350)
